...
import { createEdge, edgeConnectingConfig } from './sld_nodes/Edge';
...
export default function GraphCanvas({ graphRef, mode, setSelectedNode, onGraphChange }) {
  ...
  useEffect(() => {
    if (graphRef.current) {
      graphRef.current.options.interacting = { 
        nodeMovable: mode !== 'user', 
        edgeMovable: mode !== 'user', 
